...
class Profile extends Component {
  ...
  componentDidMount = () => {
    ...
    console.log(d, n);
    axios.get(`https://blockchainkyc.infura-ipfs.io/ipfs/${this.props.detail[1]}`).then(
      (res) => {
    ...
    axios.get(`https://blockchainkyc.infura-ipfs.io/ipfs/${this.props.detail[2]}`).then(
      (res) => {
        let de = decrypt(res.data, d, n);
    ...
    axios.get(`https://blockchainkyc.infura-ipfs.io/ipfs/${this.props.detail[3]}`).then(
      (res) => {
        let de = decrypt(res.data, d, n);
    ...
    axios.get(`https://blockchainkyc.infura-ipfs.io/ipfs/${this.props.detail[4]}`).then(
      (res) => {
        let de = decrypt(res.data, d, n);
